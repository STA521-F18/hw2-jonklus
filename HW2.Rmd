...
```{r}
ggplot(data = UN3, aes(x = Frate, y = ModernC)) + geom_point(na.rm = TRUE) + labs(title = "Contraceptive Use vs. Adult Female Economic Activity", caption = "% females using modern contraception plotted against % females >15 years that are economically active for each country in UN3 data")
```
