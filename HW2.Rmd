...
author: '[Jonathan Klus, jkk31 jonklus]'
...
```{r}
UN3_num = select(UN3,c(Change,PPgdp,Frate,Pop,Fertility,Purban))
...
ggarrange(y_frate, y_purban, labels = c("A","B"), nrow = 2, ncol = 1)
...
summary(contra_lm)
plot(contra_lm)
# ggarrange(diagnostics, labels = c("A","B","C","D"), ncol = 2, nrow = 2)
```
