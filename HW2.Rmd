...
percent use of modern contraception. In Chart B, the relationship between 
...
```
```{r}
boxTidwell(ModernC ~ PPgdp + Fertility + Pop, ~Change + Frate + Purban, UN3_clean)
boxTidwell(ModernC ~ PPgdp + Pop , ~Change + Frate + Fertility + Purban, UN3_clean)
```
